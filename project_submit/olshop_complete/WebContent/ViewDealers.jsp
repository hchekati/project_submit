...
<tr>
                    <td width="675">
<fieldset>
					<legend><span class="style3">View Dealers</span></legend>
                    <br />
                    <form name="f" method="post" action="ChangeStatus.jsp">
 <input type="hidden" name="page" value="ViewDealers.jsp"/>
 ...
 %> 
        <td bgcolor="#C3D7BA"><div align="center" class="style7"><a href="EditDealer.jsp?id=<%=loginname%>&tpage=ViewDealers.jsp?header=list"><%=loginname%></a></div></td> 
        <td bgcolor="#C3D7BA"><div align="center" class="style7"><a href="EditDealer.jsp?id=<%=loginname%>&tpage=ViewDealers.jsp?header=list"><%=profile.getFirstName()%> <%=profile.getLastName()%></a></div></td>
        ...
        <%
        if(profile.getStatus()==1){%>Active<%}if(profile.getStatus()==0){%>InActive<%}%></span></div></td>
      </tr>
      <%
      	}
      		} else {
