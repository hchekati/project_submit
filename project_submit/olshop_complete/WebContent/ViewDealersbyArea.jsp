...
<tr>
                    <td width="675">
<fieldset>
			  <legend><span class="style3">View Dealers By Area</span></legend>
 ...
 %> 
        <td bgcolor="#C3D7BA"><div align="center" class="style7"><a href="EditDealer.jsp?id=<%=loginname%>&tpage=ViewDealersbyArea.jsp?header=list"><%=loginname%></a></div></td> 
        <td bgcolor="#C3D7BA"><div align="center" class="style7"><a href="EditDealer.jsp?id=<%=loginname%>&tpage=ViewDealersbyArea.jsp?header=list"><%=profile.getFirstName()%> <%=profile.getLastName()%></a></div></td>
